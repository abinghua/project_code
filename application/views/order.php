...
<!--<div class="mb_detail_1">
  <div class="danjuhao"><ul><li class="danjuhao_3">单据号：</li><li class="danjuhao_1"><?php echo $xjList['xj_no'];?></li><li class="danjuhao_0">截止日期：</li><li class="danjuhao_1"><?php echo date('Y-m-d',strtotime($xjList['end_date']));?></li><li class="danjuhao_0">状态：</li><li class="danjuhao_1"><?php echo $xjList['statename'];?></li></ul></div>
</div>  -->
...
<div class="mb_detail_2">  
 <div class="danjuhao"><ul><li class="danjuhao_3">单据号：</li><li class="danjuhao_1"><?php echo $xjList['xj_no'];?></li><li class="danjuhao_0">截止日期：</li><li class="danjuhao_1"><?php echo date('Y-m-d',strtotime($xjList['end_date']));?></li><li class="danjuhao_0">状态：</li><li class="danjuhao_1"><?php echo $xjList['statename'];?></li><li class="danjuhao_0">最后编辑时间：</li><li class="danjuhao_1"><?php echo $xjList['edit_time'];?></li></ul></div>
...
<div class="mb_detail_3">
 <div class="detail_3">
  ...
  <ul>
  <li><span>项目名称:</span><?php echo $xjList['project_name'];?><span class="juli">地区限制:</span><?php echo $xjList['project_addr'];?></li>
...
<div class="mb_detail_5">  
<ul>
<li class="cl1">材料名称</li>
<li class="cl0">所属分类</li>
<?php 
	if($xjList['state_id'] >=2){
	?>
	<li class="cl0">已报价数</li>
	<?php
	}
?>
<li class="cl2">产品规格</li>
<li class="cl3">型号</li>
<li class="cl4">品牌</li>
<li class="cl5">单位</li>
<li class="cl6">&nbsp;&nbsp;数量</li>
<li class="c15">地区限制</li>
<li class="cl7">备注</li>
<li class="cl9">&nbsp;&nbsp;操作</li>
</ul>
</div>
			<div class="mb_detail_6">
				...
				?>
				<li><a href="<?php echo base_url().'index.php/order?xjid='.$xjList['xj_id'].'&catid=0'?>" /> 全部（<?php echo $totalCat;?>）</a></li>
				<?php
					foreach($catCount as $val){
				?>
				<li><a href="<?php echo base_url().'index.php/order?xjid='.$xjList['xj_id'].'&catid='.$val['catid']?>" > <?php echo $val['catname']?>（<?php echo $val['count']?>）</a></li>
				<?php 
					}
				?>
				</ul>
...
<table width="971" cellpadding="0" cellspacing="0" border="1" style='margin:0 auto;' id='dataDis'>
	...
	foreach($detail as $key =>$val){
		...
		$data_detail[$key]['sample'] = $val['to_sample'];
	?>
    <tr height='40' class='<?php echo $val['catid'];?>'>
    <td class="xx1" width="159px;" style=" text-align:center;"><a href="<?php echo base_url().'index.php/cat_detail?itemid='.$val['itemid'];?>" target="_blank"><span style=" display:block;width:120px;overflow:hidden;text-overflow: ellipsis;white-space: nowrap;course:hand;"><?php echo $val['cat_name'];$data_detail[$key]['name'] = $val['cat_name'];?></span></td>
	<td class="xx0" width="66px;"style=" text-align:center;"><span style=" display:block;width:60px;overflow:hidden;text-overflow: ellipsis;white-space: nowrap;course:hand; text-align:center"><?php echo $val['catname'];$data_detail[$key]['catname'] = $val['cat_name'];?></span></td>
	<?php 
		if($xjList['state_id'] >=2){
	?>
	<td class="xx0" width="66px;"style=" text-align:center;"><span style=" display:block;width:60px;overflow:hidden;text-overflow: ellipsis;white-space: nowrap;course:hand; text-align:center"><?php echo isset($val['ansCount']) ? $val['ansCount'] : 0 ;?></span></td>
	<?php
	}
	?>
    <td class="xx2" width="120px;"style=" text-align:center;"><span style=" display:block;width:100px;overflow:hidden;text-overflow: ellipsis;white-space: nowrap;course:hand; text-align:center"><?php echo $val['standard'];$data_detail[$key]['standard'] = $val['standard'];?></span></td>
    <td class="xx3" width="110px;"style=" text-align:center;"><span style=" display:block;width:90px;overflow:hidden;text-overflow: ellipsis;white-space: nowrap;course:hand; text-align:center"><?php echo $val['model'];$data_detail[$key]['model'] = $val['model'];?></span></td>
    <td class="xx4" width="82px;"style=" text-align:center;"><span style=" display:block;width:72px;overflow:hidden;text-overflow: ellipsis;white-space: nowrap;course:hand; text-align:center"><?php echo $val['brand'];$data_detail[$key]['brand'] = $val['brand'];?></span></td>
    <td class="xx5" width="40px;"style=" text-align:center;"><span style=" display:block;width:30px;overflow:hidden;text-overflow: ellipsis;white-space: nowrap;course:hand; text-align:center"><?php echo $val['unit'];$data_detail[$key]['unit'] = $val['unit'];?></span></td>
    <td class="xx6" width="45px;"style=" text-align:center;"><span style=" display:block;width:35px;overflow:hidden;text-overflow: ellipsis;white-space: nowrap;course:hand; text-align:center"><?php echo $val['count'];$data_detail[$key]['count'] = $val['count'];?></span></td>
	<td style=" text-align:center;"><span><?php echo $val['areaname'];$data_detail[$key]['item_limit'] = $val['limit_areaid'];?></span></td>
    <td class="xx7" width="210px;"style=" text-align:center;"><span style=" display:block;width:200px;overflow:hidden;text-overflow: ellipsis;white-space: nowrap;course:hand; text-align:center"><?php echo $val['remark'];$data_detail[$key]['remark'] = $val['remark'];?></span></td>
  
    <td class="xx9" width="45px;"style=" text-align:center;">
		<span style=" display:block;width:35px;overflow:hidden;text-overflow: ellipsis;white-space: nowrap;course:hand; text-align:center"><?php 
			if($xjList['state_id'] <=1){
		?>
			<a href="javascript:void(0);" onclick="viewDetail(<?php echo $val['detail_id'];?>)"><img  style="border:0;" src="<?php echo base_url()?>file/member/tj.gif" /></a>&nbsp;<a href="javascript:void(0)" onclick="deleteDetail(<?php echo $val['detail_id'];?>)" ><img style="border:0;" src="<?php echo base_url()?>file/member/sc.gif" /></a>
		<?php
		}else{
		?>
					<a href="<?php echo base_url()."index.php/bid?xjid={$xjList['xj_id']}&detailid={$val['detail_id']}";?>" >查看</a>
		<?php
...
<form action="<?php echo base_url()?>index.php/order/updateDetail" method="post" enctype='multipart/form-data' target="updateDetail" onsubmit="return validate();">
  <div class="tanchuang_1">
   <ul>
   <li>当前位置:<input type="hidden" name="detailId" class='detailId_H' value=''></li>
   <li><?php echo $xjList['project_name'];?></li>
   <li>（单据号：<?php echo $xjList['xj_no'];?> <input class="xjId" type="hidden" name="xjId" value="<?php echo $xjList['xj_id'];?>">截止日期：<?php echo date('Y-m-d',strtotime($xjList['end_date']));?>） </li>
  ...
  <li>
	<span>品&nbsp;&nbsp;&nbsp;&nbsp;牌：</span><input type="text" name='brandIn' value="" maxlength="20" class="brand" /><span>单&nbsp;&nbsp;&nbsp;&nbsp;位：</span><span style="position:absolute;margin-left:0px;padding:0px;margin:0px;">
	<p class="dys">
		<select name="oks" id="oks" onchange="document.getElementById('okw').value=this.value;">
			<option value="斤">斤</option>
			<option value="吨">吨</option>
			<option value="克">克</option>
			<option value="克">平方米</option>
			<option value="克">升</option>
			<option value="克">桶</option>
			<option value="克">盒</option>
			<option value="克">打</option>
		</select>
	</p>
	<p class="dyw"><input type="text" name="unitIn" id="okw" class='unit' value="" /></p>
	</span>
 </li>
  <li><span>数&nbsp;&nbsp;&nbsp;&nbsp;量：</span><input type="text" name='countIn' value="" maxlength="20" class="count" ><span>是否送样：</span><input  name="sample" type="checkbox" class="sample"/><span>是否限制地区：</span><input  name="item_limit" type="checkbox" class="item_limit"/></li>
...
<script type="text/javascript">
	...
	function addAreaArr(){
		var areaid = $('.areaAreaid').val();
		var areaName = $(".areaName").val();
		var areaidList = $('.areaAreaidList').val();
		var areaNameList = $('.areaNameArr').val();
		if(areaid == -1){
			return false;
		}
		if(areaidList){
	...
	function viewDetail(id){
		for(i=0;i<detail.length;i++){
			if(detail[i].detailId ==id){
				...
				$(".remark").html(detail[i].remark);
				$(".detailId_H").val(detail[i].detailId);
				$(".sample").attr("checked",detail[i].sample!=0 ? true : false);
				$(".item_limit").attr("checked",detail[i].item_limit!=0 ? true : false);
	...
	/*
	function displayCat(catid,checked){}
	*/
	...
	function saveOrder(){
		...
		var areaNameArr = $('.areaNameArr').val();
		var end_date = $(".end_date").val();
		var areaAreaidList = $('.areaAreaidList').val();
		...
		var param = "xjId="+xjId+"&project_name="+project_name+"&areaNameArr="+areaNameArr+"&end_date="+end_date+"&remark="+remark+"&areaAreaidList="+areaAreaidList+"&v="+time;
		param = encodeURI(param);//解决传递中文乱码问题
		$.ajax({
			url:base_url+"index.php/order/orderDo?"+param
		}).done(function(data){
			var myObject = eval('(' + data + ')');
			if(myObject.flag){
				window.location = base_url+"/index.php/order?xjId="+myObject.xjId;
			}else{
				alert(myObject.msg);
			}
		});
	...
	function deleteDetail(detail_id){
		...
		if(!confirm('是否要删除这条记录?')){
			...
			window.location = base_url+"index.php/order/deleteDetail?"+param
		}
		/*
		$.ajax({
	...
	function load_area(areaid){
		if(areaid){
			$(".addr").val(areaid);
			$.ajax({
				url:base_url+"index.php/index/ajax?areaid="+areaid
			}).done(function(data){
				if(data!=null&&data.replace(/(^\s*)|(\s*$)/g,'')!=""){
					$(".sel").html(data);
				}
