		...
		<div class="detail_1">
			<div class="detai_zong">
				...
				<div class="detail_zong_1">
					<div class="detai_zong_1_1" style="line-height:347px;text-align:center;">
							<span>
				...
				<div class="js_refresh">
					...
					<div class="liuyan">
						<ul>
							...
							<li>评论时间：<?php echo $reply['date']?>&nbsp;&nbsp;&nbsp;&nbsp;会员：<a
								href="<?php echo $reply['user_id']?>"><?php echo $reply['user_name']?>
							</a>
							</li>
						</ul>
					</div>
				...
				<div class="denglu">
					<div class="denglu_1">
						<ul>
							...
							<li><input type="image"
								src="<?php echo base_url()?>file/images/liuyan_a.jpg"
								class="commitMsg" onclick="javascript:void(0)"></li>
						</ul>
					</div>
				</div>
				<!--登录END-->
